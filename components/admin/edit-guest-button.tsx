...
import { updateGuestDetails } from "@/lib/actions/admin-players";

export function EditGuestButton({
  playerId,
  name,
  duprId,
}: {
  ...
  function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      const result = await updateGuestDetails(playerId, {}, formData);
      if (result.error) {
  ...
  return (
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Edit guest">
